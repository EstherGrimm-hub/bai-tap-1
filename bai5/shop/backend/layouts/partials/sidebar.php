...
<nav class="col-md-2 d-none d-md-block sidebar">
  <div class="sidebar-sticky">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a href="/shop/backend/pages/dashboard.php">Dashboard <span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          <li class="dropdown-item">
            <a href="/shop/backend/functions/product/index.php">Product List</a>
          </li>
          <li class="dropdown-item">
            <a href="/shop/backend/functions/product/create.php">Create</a>
          </li>
        </ul>
      </li>
