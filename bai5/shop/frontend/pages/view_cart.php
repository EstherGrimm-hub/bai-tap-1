            ...
            <div class="row">
                <div class="col col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (empty($item['image'])) : ?>
                                                <img src="/shop/assets/shared/img/default-image_600.png" class="imgfluid image" />
                                            <?php else : ?>
                                                <img
                                                    src="/shop/assets/<?= $item['image'] ?>" class="img-fluid image" />
                                            <?php endif; ?>
                                        </td>
                                        <td><?= $item['name'] ?></td>
                                        <td>
                                        ...
                                        <td><?=
                                            number_format($item['price'], 3, ".", ",") ?> vnđ</td>
                                        <td><?=
                                            number_format($item['quantity'] * $item['price'], 3, ".", ",") ?>
                                            vnđ</td>
                                        <td>
                                            <a id="delete_<?= $no ?>"
                    ...
                    <?php else : ?>
                        <h2>Cart Empty</h2>
                    <?php endif; ?>
                    <a href="/shop/frontend" class="btn btn-warning btn-md"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                        Continue Shopping</a>
                    <a href="/shop/frontend/pages/checkout.php"
...
<script>
    $(document).ready(function() {
        function removeCartItem(id) {
            $.ajax({
                url: '/shop/frontend/API/removeCartItem.php',
                method: "POST",
                dataType: 'json',
                data: { id: id },
        ...
        function updateCartItem(id, quantity) {
            ...
            $.ajax({
                url: '/shop/frontend/API/updateCartItem.php',
                method: "POST",
                dataType: 'json',
