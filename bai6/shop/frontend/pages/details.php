...
$stmt = $conn->prepare("SELECT id, productname, price, description, stock_quantity, image_url, category FROM products WHERE id = ?");
            ...
            <div class="row">
                ...
                <div class="col-md-5 text-center p-4">
                    <div class="preview-pic mb-3">
                        <img src="/shop/assets/<?= htmlspecialchars($product['image_url']) ?>"
                    ...
                    <ul class="preview-thumbnail nav nav-tabs justify-content-center">
                        <?php foreach ($productImages as $img): ?>
                            <li class="mx-1">
                                <img src="/shop/assets/<?= htmlspecialchars($img) ?>"
                                    alt="thumbnail"
                                    class="img-thumbnail">
                            </li>
                        <?php endforeach; ?>
        ...
        function handleAddCart() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var htmlString = `✅ Sản phẩm đã được thêm! <a href="/shop/frontend/pages/viewCart.php">Xem giỏ hàng</a>`;
